object Frm_KhInfo: TFrm_KhInfo
  ...
  object Panel1: TPanel
    ...
    object DBEdit1: TDBEdit
      ...
      Height = 21
      DataField = 'Ku_Name'
      DataSource = DM_XS.DataSource_kehu
      TabOrder = 0
    end
    ...
    object cxDBDateEdit1: TcxDBDateEdit
      Left = 82
      Top = 226
      DataBinding.DataField = 'Ku_DateTime'
      DataBinding.DataSource = DM_XS.DataSource_kehu
      TabOrder = 3
      Width = 185
    end
