object Frm_cgInput: TFrm_cgInput
  Left = 0
  Top = 0
  Caption = #37319#36141#25968#25454#36755#20837
  ClientHeight = 526
  ClientWidth = 450
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    Align = alClient
    TabOrder = 0
    object scGPEd_name: TscGPDBEdit
      Left = 32
      Top = 16
      Width = 265
      Height = 23
      ...
      RightButton.Width = 0
      CustomDraw = False
      Text = #21556#20029#23071
      Color = clBtnFace
      TabOrder = 0
      DataField = 'cg_lianxieren'
      DataSource = DM_XS.DataSource_cg
    end
    object scGPDBEdit1: TscGPDBEdit
      Left = 32
      Top = 59
      Width = 265
      Height = 23
      ...
      ContentMarginTop = 5
      ContentMarginBottom = 5
      PromptText = #32852#31995#30005#35805
      HidePromptTextIfFocused = False
      PromptTextColor = clNone
      Transparent = True
      LeftButton.Kind = scgpebCustom
    ...
    object scGPDBEdit2: TscGPDBEdit
      Left = 32
      Top = 102
      Width = 265
      Height = 23
      ...
      ContentMarginTop = 5
      ContentMarginBottom = 5
      PromptText = #20844#21496#21517#31216
      HidePromptTextIfFocused = False
      PromptTextColor = clNone
      Transparent = True
      LeftButton.Kind = scgpebCustom
      ...
      RightButton.Width = 0
      CustomDraw = False
      Text = #24120#24030#27427#25463
      Color = clBtnFace
      TabOrder = 2
      DataField = 'cg_gys'
      DataSource = DM_XS.DataSource_cg
    end
    object scGPDBEdit3: TscGPDBEdit
      Left = 32
      Top = 145
      Width = 265
      Height = 23
      ...
      ContentMarginTop = 5
      ContentMarginBottom = 5
      PromptText = #20135#21697#21517#31216
      HidePromptTextIfFocused = False
      PromptTextColor = clNone
      Transparent = True
      LeftButton.Kind = scgpebCustom
      ...
      RightButton.Width = 0
      CustomDraw = False
      Text = #35199#37096#25968#25454#31227#21160#30828#30424'1TB'
      Color = clBtnFace
      TabOrder = 3
      DataField = 'cg_cp'
      DataSource = DM_XS.DataSource_cg
    end
    object scGPDBEdit4: TscGPDBEdit
      Left = 32
      Top = 188
      Width = 265
      Height = 23
      ...
      RightButton.Width = 0
      CustomDraw = False
      Text = #23458#25143#20195#36141
      Color = clBtnFace
      TabOrder = 4
      DataField = 'cg_yongtu'
      DataSource = DM_XS.DataSource_cg
    end
    object scGPDBEdit5: TscGPDBEdit
      Left = 32
      Top = 231
      Width = 265
      Height = 23
      ...
      Color = clBtnFace
      TabOrder = 5
      DataField = 'cg_dainjian'
      DataSource = DM_XS.DataSource_cg
    end
    object scGPDBEdit6: TscGPDBEdit
      Left = 32
      Top = 274
      Width = 265
      Height = 23
      ...
      Color = clBtnFace
      TabOrder = 6
      DataField = 'cg_shuliang'
      DataSource = DM_XS.DataSource_cg
    end
    object scGPDBEdit8: TscGPDBEdit
      Left = 32
      Top = 317
      Width = 265
      Height = 23
    ...
    object scDBDateEdit1: TscDBDateEdit
      ...
      PromptText = #37319#36141#26085#26399
      PromptTextColor = clNone
      HidePromptTextIfFocused = False
      WallpaperIndex = -1
      BlanksChar = ' '
      Date = 44095.000000000000000000
      TodayDefault = False
      CalendarWidth = 200
      CalendarHeight = 150
    ...
    object scDBDateEdit2: TscDBDateEdit
      ...
      CustomBackgroundImageHotIndex = -1
      CustomBackgroundImageDisabledIndex = -1
      PromptText = #32467#24080#26085#26399
      PromptTextColor = clNone
      HidePromptTextIfFocused = False
      WallpaperIndex = -1
      BlanksChar = ' '
    ...
    object scGPDBEdit7: TscGPDBEdit
      Left = 32
      Top = 432
      Width = 264
      Height = 84
      ...
      ContentMarginTop = 5
      ContentMarginBottom = 5
      PromptText = #22791#27880#20449#24687
      HidePromptTextIfFocused = False
      PromptTextColor = clNone
      Transparent = True
      LeftButton.Kind = scgpebCustom
