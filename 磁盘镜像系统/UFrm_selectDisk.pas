...
uses
  MiTeC_StrUtils, MiTeC_Routines, MiTeC_Storage, shellapi, uFrmMain;
{$R *.dfm}
...
begin
  ...
  begin
    Form2.lbl_Yuan_Mode.Caption := hddMode;
    Form2.lbl_Yuan_Sn.Caption := hddSn;
    Form2.lbl_yuan_szie.Caption := hddSize.ToString;
    Form2.lbl_Yuan_prot.Caption := hddProt;
    Form2.lbl_start.Caption := '0';
    Form2.lbl_end.Caption := hddSize.ToString;
    Form2.EndSec := hddSize;
    Close;
  end
  else
  begin
    Form2.lbl_MuBiao_Mode.Caption := hddMode;
    Form2.lbl_MuBiao_SN.Caption := hddSn;
    Form2.lbl_MuBiao_size.Caption := hddSize.ToString;
    Form2.lbl_MuBiao_prot.Caption := hddProt;
