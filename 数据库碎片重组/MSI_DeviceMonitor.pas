...
type
  ...
  TVolumeChangeEvent = procedure(Sender: TObject; Drive: char; Remote: boolean) of object;
...
function GetVolumeDrive(AUnitMask: Cardinal): char;
var
  i: Cardinal;
  n: Double;
begin
